...
namespace SmartClinicQueue.Infrastructure.Persistance.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_QueueTickets_Users_PatientId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QueueTickets_DoctorId_Status",
                table: "QueueTickets",
                columns: new[] { "DoctorId", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_QueueTickets_DoctorId_TicketNumber",
                table: "QueueTickets",
                columns: new[] { "DoctorId", "TicketNumber" });

            migrationBuilder.CreateIndex(
                name: "IX_QueueTickets_PatientId_Status",
                table: "QueueTickets",
